                            ...
                            <div>
                                {isBankConnected ? (
                                    <div className="p-3 bg-light border border-success rounded-3 mb-3 small">
                                        <span className="text-success fw-bold">✓ Bank connected</span>
                                        <p className="text-secondary mb-0 mt-1">Your bank account is successfully connected. We will automatically sync and match your receipts with bank transactions.</p>
                                    </div>
                                ) : (
                                    <div className="p-3 bg-light border border-info rounded-3 mb-3 small">
                                        <span className="text-info fw-bold">ℹ Action Required</span>
                                        <p className="text-secondary mb-0 mt-1">Connect your bank securely via Plaid (PSD2 flow) to enable automatic receipt-to-transaction matching.</p>
                                    </div>
                                )}
